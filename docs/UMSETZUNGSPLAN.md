...
| **W3** Daten & Versionen | yfinance raus aus Prod-Pfad, Strategieversion je Signal, Mode-Dashboards, Scheibe 9 | **P2, P5, P6** | 🔄 laufend (Tor T0 ✅; W3.1 Scheibe 9 ✅ `cba7380`; **W3.2 yfinance-Ablösung ✅ — Prod-Signalpfad Alpaca-only, Gate P2**; W3.3–W3.6 offen) |
