...
| **W3** Daten & Versionen | yfinance raus aus Prod-Pfad, Strategieversion je Signal, Mode-Dashboards, Scheibe 9 | **P2, P5, P6** | 🔄 laufend (Tor T0 ✅; W3.1 ✅; **W3.2 yfinance-Ablösung ✅ [Alpaca-only, Gate P2]; W3.3 Strategieversion je Signal ✅ [Gate P5]**; W3.4–W3.6 offen) |
