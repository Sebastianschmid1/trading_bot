...
| **W3** Daten & Versionen | yfinance raus aus Prod-Pfad, Strategieversion je Signal, Mode-Dashboards, Scheibe 9 | **P2, P5, P6** | 🔄 laufend (Tor T0 ✅; W3.1 ✅; **W3.2 ✅ [Alpaca-only, P2]; W3.3 ✅ [P5]; W3.4 Mode-Reports ✅ [P6/RES-002]; W3.5 Shadow+Roharchiv ✅**; nur W3.6 [Exit-Policies, Tor T2] offen) |
